...
<html>
<head>
    <title>XSEDE Client Authorization</title>
                    ...
                    <table border=0>
                        ...
                        <tr>
                            <td> The XSEDE Client listed below is requesting access to your
                                XSEDE account. If you approve, please sign in with your XSEDE username and password. For help or clarification on why you are presented with this screen please contact the XSEDE Help Desk.
                                <br><br>
                                <i>Name:</i> ${clientName}
                                <br>
                                <i>URL:</i> ${clientHome}
