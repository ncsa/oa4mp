...
<br><br>IMPORTANT NOTE: It is the client's responsibility to store the identifier and any secret.
Your client will need to use it to identify itself. Please keep these in a safe location.
If you lose the secret, you will have to
re-register. Be sure you copy the secret without line breaks (which some browsers will insert) or you will
