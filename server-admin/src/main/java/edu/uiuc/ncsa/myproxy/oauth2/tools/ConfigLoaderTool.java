...
import edu.uiuc.ncsa.oa4mp.oauth2.client.XMLClientLoader;
...
public class ConfigLoaderTool {
    public  ConfigurationLoader<? extends AbstractEnvironment> figureOutLoader(String fileName, String configName, String componentName) throws Throwable {
