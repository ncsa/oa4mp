...
public class QDLACL implements Serializable {
    ...
    public class AddToACL implements QDLFunction {
        ...
        public Object evaluate(Object[] objects, State state) {
            ...
            if (objects.length != 1) {
                throw new IllegalArgumentException("Error: " + getName() + " requires an argument");
            }
            List<Object> ids;
            switch (Constant.getType(objects[0])) {
                ...
                case Constant.STRING_TYPE:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Error: " + getName() + " requires a string or stem as its argument");
            ...
            for (Object id : ids) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Error: " + getName() + " requires a valid identifier");
                }
    ...
    public class CheckACL implements QDLFunction {
        ...
        public Object evaluate(Object[] objects, State state) {
            ...
            if (oa2State.getClientID() == null) {
                for (Identifier id : oa2State.getAdminIDs()) {
                    if (oa2State.getAclList().contains(id)) {
                        return Boolean.TRUE;
                    }
                }
            } else {
        ...
        public List<String> getDocumentation(int argCount) {
            List<String> doxx = new ArrayList<>();
            doxx.add(getName() + " check the current access list. If there is no such entry, an illegalaccess is triggered.");
