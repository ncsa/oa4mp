...
import org.oa4mp.server.loader.oauth2.cm.util.admin.AdminClientServer;
import org.oa4mp.server.loader.oauth2.cm.util.attributes.AttributeServer;
import org.oa4mp.server.loader.oauth2.cm.util.client.ClientServer;
...
import static org.oa4mp.server.api.admin.things.SAT.*;
import static org.oa4mp.server.api.admin.things.SATFactory.*;
import static org.oa4mp.server.loader.oauth2.cm.util.RequestFactory.createRequest;
