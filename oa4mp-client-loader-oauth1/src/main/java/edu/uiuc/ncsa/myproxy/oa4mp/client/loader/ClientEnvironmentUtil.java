...
public class ClientEnvironmentUtil {
    public static ClientEnvironment load(File configFile, String configName) throws Exception{
        return new ClientLoader(ConfigUtil.findConfiguration(configFile.getAbsolutePath(), configName, ClientXMLTags.COMPONENT)).load();
    }
     ...
     * @throws Exception
     */
    public static ClientEnvironment load(File configFile) throws Exception{
